...
<head>
    ...
    <title>{{ config('app.name', 'Tendering') }}</title>
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                ...
                                <div>
                                    ...
                                    <span class="font-weight-bold">you have been awarded a new tender, 'T&C' is ready to download!</span>
                                </div>
                            </a>
                            <a class="dropdown-item d-flex align-items-center" href="#">
                                <div class="mr-3">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Mpho Mokhure 201404824</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
        ...
        var table = $('#example1').DataTable({
            ...
            , "drawCallback": function (settings) {
                ...
                api.column(groupColumn, {
                    ...
                    if (last !== group) {
                        $(rows).eq(i).before(
                            '<tr class="group alert-primary"><td colspan="6">' + group + '</td></tr>'
                        );
